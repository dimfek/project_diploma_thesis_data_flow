The purpose of this application is to represent the data flow from the acquisition of data (ex. temperature) from sensors to the storage of data in databases 
